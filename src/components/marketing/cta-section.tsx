...
export function CtaSection({
  ...
  return (
    <section
      ...
      className={cn('home-section bg-[var(--violet-50)]', className)}
    >
      <Container>
        <div
          className={cn(
          ...
          >
            ...
            {secondaryAction && (
              <Link
                ...
                className="inline-flex min-h-13 items-center justify-center px-6 py-3 text-sm font-semibold text-[var(--text-primary)] underline underline-offset-8"
              >
