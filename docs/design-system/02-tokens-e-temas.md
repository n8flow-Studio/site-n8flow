...
## 2.3 Tokens semânticos light-first
...
[data-theme='light'] {
  ...
  --border-subtle: rgb(9 13 18 / 0.1);
  --border-default: rgb(9 13 18 / 0.18);
  --border-strong: rgb(9 13 18 / 0.34);
...
Tema escuro deixa de ser a abordagem principal e só deve ser mantido se houver uso contextual completo e aprovado.
...
[data-theme='light'] {
  ...
  --text-muted: var(--neutral-600);
  --border-subtle: rgb(9 13 18 / 0.1);
  --border-default: rgb(9 13 18 / 0.16);
  --border-strong: rgb(9 13 18 / 0.28);
  --text-link: var(--violet-700);
  --focus-ring: var(--violet-500);
}
```
...
--gradient-brand-soft: linear-gradient(135deg, rgb(0 245 160 / 0.16), rgb(110 68 255 / 0.18));
--gradient-hero:
  radial-gradient(circle at 20% 10%, rgb(0 245 160 / 0.16), transparent 38%),
  radial-gradient(circle at 80% 20%, rgb(110 68 255 / 0.22), transparent 42%);
...
--shadow-lg: 0 20px 60px rgb(0 0 0 / 0.38);
--glow-green: 0 0 32px rgb(0 245 160 / 0.18);
--glow-violet: 0 0 40px rgb(110 68 255 / 0.22);
```
