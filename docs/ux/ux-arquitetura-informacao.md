...
- Base visual light-first, institucional e editorial.
- Verde como energia/ação/conversão.
- Roxo como inteligência/tecnologia.
- Neutros escuros para profundidade.
- Linhas, grids, nós, fluxos e diagramas de arquitetura como elementos gráficos.
- Composição sofisticada, assimétrica e com menor dependência de cards.
- Gradientes, glows e pills restritos a exceções funcionais.
