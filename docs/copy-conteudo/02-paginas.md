...
Todo texto é revisado em 2026-09-14 conforme nova direção de comunicação (sem uso do termo "Growth" na copy pública).

## Home

H1: Apareça no lugar certo. Capture os clientes certos.
...
Tese — H2: Seu negócio no lugar certo, com o processo certo para atender e fidelizar clientes.

Método — H2: Da primeira conversa à solução implementada.

Soluções — H2: Soluções para cada necessidade do seu negócio.
...
H1: Soluções sob medida para o que o seu negócio precisa.
...
H1: Fazemos o digital trabalhar a favor do seu negócio.
...
H1: Do diagnóstico à solução: um processo claro, do começo ao fim.

Eyebrow: Como trabalhamos.

Lead: A assessoria começa entendendo o que você precisa. Só depois definimos o que implementar — e acompanhamos cada resultado.

H2: Cada empresa tem um ponto de partida diferente.
